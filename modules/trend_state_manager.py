...
def fetch_naver_all_data(keyword, category_id):
    ...
    if not category_id:
        return {'top_queries': related, 'category_ranking': [], 'time_series': pd.DataFrame()}
